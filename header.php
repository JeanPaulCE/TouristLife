...
<header>
        <section class="nav-sec ">
            <nav class="nav-bar inner-grid">
                ...
                <div class="end">
                    <ul class="nav-items">
                        <li class="nav-item"><a class="a-link" href="./index.php">inicio</a></li>

                        
                        <li class="nav-item-cluster menu2">
                            <label for="menu2" class="a-link label-cl">categoria</label>
                        ...
                        <?php
                            if(isset($_SESSION["id"])){
                                ...
                                echo '<li class="nav-item"><a class="a-link" href="./inicio-sesion.php">Ingresar/Registrarse</a></li>';
                            }
                        ?> 
