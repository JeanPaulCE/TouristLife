...
<body>
    ...
    <header>
        <section class="nav-sec ">
            <nav class="nav-bar inner-grid">
                <div class="d-logo">
                    <a href="./index.html" class="logo">Tourist<span>Life</span></a>
                </div>
                <div>
    ...
    <section class="top-section">
        ...
        <div class="center ts-text">
            ...
            <div class="center">
                <a class="form-submit" href="./galeria.html">Galeria</a>
            </div>
        </div>
    </section>
            ...
            <div class="element-1 inner-grid">
                <div class="container">
                    ...
                    <div class="element-data-2">
                        <a class="element-a-1" href="./detalle-lugar.html">más <i class="fas fa-arrow-right"></i> </a>
                    </div>
                </div>
            </div>
            <div class="center">
